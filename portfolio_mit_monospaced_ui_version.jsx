// To use the 'JetBrains Mono' font, add the following line to the <head> of your main HTML file (e.g., index.html):
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      const mixColor = (c1, c2, f) => {
        ...
        const b1 = Math.round(lerp(a & 255, b & 255, f));
        return `rgb(${r},${g},${b1})`;
      };
...
function CursorHalo() {
    ...
    useEffect(() => {
      ...
      const draw = () => {
        ...
        const r = 26 * (dpr || 1);
        const g = ctx.createRadialGradient(smooth.current.x, smooth.current.y, 0, smooth.current.x, smooth.current.y, r * 2.2);
    ...
    return <canvas ref={ref} className="fixed inset-0 pointer-events-none z-[60] mix-blend-screen opacity-70" aria-hidden />;
}
...
const person = {
    ...
    avatar: "/profile.jpg",
    about:
      "Research-focused EEE graduate working on decentralized hybrid renewables, nanosatellite EPS, and lead-free perovskites. Interests span loT, control, techno-economics, and photonics-based comms.",
};
...
export default function PortfolioMIT() {
    ...
    const researchExp = [
        {
          ...
          long: "Built a co-optimized scheduling strategy for PV+hydrokinetic+storage. Addressed fluctuating water levels, sedimentation, and PV soiling via control and maintenance windows.",
        },
        {
            ...
            long: "Investigated contact energetics and transport layers. Simulated optical-electrical coupling to estimate achievable device stack efficiency.",
        },
        {
            ...
            long: "Designed pulsed-load tolerant EPS and prototyped free-space optical link using off-the-shelf components and custom modulation.",
        },
        {
            ...
            long: "Implemented telemetry and power budgeting for subsonic sounding model rocket effort across multiple static tests.",
        },
    ];
    ...
    const professional = [
        {
          ...
          long: "Owned model-in-the-loop validation and migrated legacy controllers to parameterized MATLAB/Simulink libraries.",
        },
    ];
    ...
    const publications = {
        journals_under_review: [
            {
                title: "Decentralized Smart Hybrid Renewable Riverine Floating Platform for 140% National Demand by 2030",
                venue: "Energy Reports",
                status: "Under review",
                long: "Presents a modular floating platform integrating PV, hydrokinetic turbines, and hybrid storage with predictive maintenance scheduling.",
                links: [{ label: "Preprint (add later)", href: "#" }],
            },
            {
                title: "Design & Performance Analysis of Lead‑Free Perovskite Solar Cells with RGO Contacts",
                venue: "Journal of Physics and Chemistry of Solids",
                status: "Under review",
                long: "Evaluates reduced graphene oxide as a back-contact with work-function tuning; demonstrates simulated PCE 21.23%.",
                links: [],
            },
        ],
        manuscripts: [
            {
              title: "Co‑Optimized CubeSat EPS Design: Predictive Scheduling with Pulsed Loads",
              venue: "Target: IEEE T-AES",
              status: "In prep",
              long: "Focus on EPS–payload co-scheduling to stabilize bus voltage under pulsed imaging workloads.",
            },
            {
              title: "Australian Desert Food+Energy with Modular Nuclear + Agrivoltaics",
        ...
        conferences: [
            {
              ...
              links: [{ label: "DOI", href: "https://doi.org/10.1109/auv53081.2022.9965924" }],
            },
            {
              ...
              links: [{ label: "DOI", href: "https://doi.org/10.1109/icict64387.2024.10839745" }],
            },
        ],
        chapters: [
            {
    ...
    return (
        <div
            ...
            style={{ 
                background: `linear-gradient(180deg, ${MIT.jet}, ${MIT.coal})`,
                fontFamily: "'JetBrains Mono', monospace", // <-- Font changed to a coding font
            }}
        >
            {/* Backgrounds */}
                ...
                <div className="relative">
                    ...
                    <div className="container mx-auto px-4 py-2">
                        <div className="flex items-center justify-between gap-3">
                            <button className="text-sm font-mono tracking-widest" onClick={() => { setActive("hero"); scrollToId("hero"); }} style={{ color: MIT.silver }}>
                                Maruf Hossain
                            </button>
                        ...
                        <div className="flex md:justify-start">
                            <div className="relative">
                                <img
                                    ...
                                    onError={(e) => { e.target.onerror = null; e.target.src='https://placehold.co/352x352/111111/A31F34?text=Profile'; }}
                                />
                                    ...
                                    preview={
                                        <>
                                            ...
                                            <ul className="mt-2 list-disc list-inside text-sm text-neutral-300">
                                                {e.bullets.map((w, wi) => (<li key={wi}>{w}</li>))}
                                            </ul>
                                        </>
                                    }
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    {teaching.map((t, i) => (
                        <Expandable
                            ...
                            preview={
                                <ul className="mt-2 list-disc list-inside text-sm text-neutral-300">
                                    {t.work.map((w, wi) => (<li key={wi}>{w}</li>))}
                                </ul>
                            }
